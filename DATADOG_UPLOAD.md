...
export DATADOG_ANDROID_APP_ID="<YOUR_ANDROID_APP_ID>"
export DATADOG_IOS_APP_ID="<YOUR_IOS_APP_ID>"
...
| `DATADOG_ANDROID_APP_ID` | Android App ID in Datadog Synthetics | UX Monitoring -> Synthetic Monitoring -> Mobile Applications -> Select Android App |
| `DATADOG_IOS_APP_ID`     | iOS App ID in Datadog Synthetics     | UX Monitoring -> Synthetic Monitoring -> Mobile Applications -> Select iOS App     |
